      ...
      <section className="grid min-h-[calc(100vh-5.5rem)] gap-5 py-5 lg:grid-cols-[0.9fr_1.1fr]">
        ...
        <motion.div initial={{ opacity: 0, scale: 0.98 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.55, delay: 0.08 }} className="grid gap-5 lg:grid-rows-[1fr_auto]">
          ...
          <div className="garden-rail temple-card rounded-lg p-5">
            ...
            <Link to="/world" className="mb-4 flex items-center justify-between gap-4 rounded-lg border border-[var(--temple-border)] bg-white/[0.045] p-4 transition hover:-translate-y-0.5 hover:bg-white/[0.07]">
              <div>
                <p className="text-sm font-black">Explore Rialo World</p>
                <p className="mt-1 text-xs leading-5 text-[var(--temple-muted)]">A living isometric temple city that explains SCALE, RWA, governance, identity, transactions, and markets.</p>
              </div>
              <Globe2 className="h-6 w-6 shrink-0 text-[var(--temple-cyan)]" />
            </Link>
