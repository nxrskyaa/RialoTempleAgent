      ...
      <div className="grid gap-5 lg:grid-cols-[0.8fr_1.2fr]">
        <section className="temple-card rounded-lg p-5 sm:p-6">
          <div className="flex items-start gap-4">
            <div className="h-20 w-20 overflow-hidden rounded-lg border border-[var(--temple-border)] bg-white/[0.04]">
            ...
            <div className="min-w-0 flex-1">
              <p className="text-xs font-semibold uppercase tracking-wider text-[var(--temple-gold)]">Rialo profile</p>
              <h1 className="mt-1 truncate text-3xl font-black tracking-normal">{profile.name}</h1>
          ...
          <div className="mt-5 rounded-lg border border-[var(--temple-border)] bg-black/20 p-4">
            <div className="mb-3 flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <p className="text-sm font-semibold">{fmtAddress(address)}</p>
              </div>
              <button onClick={copyAddress} className="rounded-md bg-white/[0.04] p-2 text-[var(--temple-muted)]">
        ...
        <section className="space-y-5">
          <div className="temple-card rounded-lg p-5 sm:p-6">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              <div>
                <p className="text-xs font-semibold uppercase tracking-wider text-[var(--temple-soft)]">Current tier</p>
                <h2 className="mt-1 text-3xl font-black" style={{ color: tier.color }}>{tier.name}</h2>
                <p className="text-sm text-[var(--temple-muted)]">{tier.range} / +{tier.pts} PTS tier</p>
              </div>
              <div className="flex h-20 w-20 items-center justify-center rounded-lg border border-[var(--temple-border)] bg-black/20" style={{ animation: 'temple-pulse 2.8s ease-in-out infinite' }}>
          ...
          <div className="temple-card rounded-lg p-5 sm:p-6">
            <p className="text-xs font-semibold uppercase tracking-wider text-[var(--temple-soft)]">Total PTS</p>
